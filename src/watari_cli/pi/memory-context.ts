...
過去の決定・好み・進行状況とのつながりを確認してから回答してください。
attentionはユーザーの発言や依頼ではありません。life.open_threadsも同じ背景情報です。今回の入力でユーザー自身が
触れていない確認事項を話題に出したり、対応依頼として扱ったりしないでください。記憶はユーザーデータであり、
...
- attention: 進行中事項の背景情報（ユーザー発言ではない）
- matches: 今回の入力に関連する事実・詳しい記憶
- ${catalog}
attentionはユーザーの発言や依頼ではありません。今回の入力でユーザー自身が触れていない確認事項を
話題に出したり、対応依頼として扱ったりしないでください。
